...
class Location extends FormRequest
{
    public function rules()
    {
        return [
            ...
            ['location_country_id', 'admin::lang.locations.label_country', 'sometimes|required|integer'],
            ['options.auto_lat_lng', 'admin::lang.locations.label_auto_lat_lng', 'sometimes|required|integer'],
            ...
            ['offer_delivery', 'admin::lang.locations.label_offer_delivery', 'sometimes|required|integer'],
            ['offer_collection', 'admin::lang.locations.label_offer_collection', 'sometimes|required|integer'],
            ['options.offer_reservation', 'admin::lang.locations.label_offer_collection', 'sometimes|required|integer'],
            ...
            ['options.future_orders', 'admin::lang.locations.label_future_order', 'sometimes|required|integer'],
            ...
            ['location_status', 'admin::lang.label_status', 'sometimes|required|integer'],
            ...
            ['options.hours.*.flexible.*.status', 'admin::lang.label_status', 'sometimes|required_if:options.hours.*.type,flexible|integer'],

            ['delivery_areas', 'admin::lang.locations.text_delivery_area', 'sometimes'],
            ['delivery_areas.*.type', 'admin::lang.locations.label_area_type', 'sometimes|required'],
            ['delivery_areas.*.name', 'admin::lang.locations.label_area_name', 'sometimes|required'],
